    ...
    <div className="min-h-screen p-4 flex flex-col items-center justify-center bg-gradient-to-br from-background via-background to-primary/10">
      ...
      <div className="w-full max-w-4xl relative z-10 space-y-6">
        ...
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center">
          <h1 className="text-2xl font-bold text-foreground mb-2">Room Lobby</h1>
          ...
          <p className="text-sm text-muted-foreground mt-2">Share this code with your friends to join</p>
        </motion.div>
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }}>
            <Card className="border-border/50 bg-card/80 backdrop-blur-xl h-full">
              ...
              <CardContent className="space-y-4">
                ...
                {/* Word Category */}
                <div className="space-y-2">
                  <Label className="text-foreground">Word Category</Label>
                  <Select
                ...
                {/* Discussion Time */}
                <div className="space-y-2">
                  <Label className="text-foreground">Discussion Time</Label>
                  <Select
                ...
                {!isHost && (
                  <p className="text-sm text-muted-foreground text-center">Only the host can change settings</p>
                )}
              </CardContent>
            </Card>
          </motion.div>
